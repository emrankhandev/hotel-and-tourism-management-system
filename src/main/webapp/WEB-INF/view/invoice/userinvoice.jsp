            ...
            <div class="invoice-box">
                ...
                <div class="row pb-30">
                    <div class="col-md-6">
                        ...
                        <p class="font-14 mb-5">Mobile Number: <strong class="weight-600"> 01922332280</strong> </p>
                        <p class="font-14 mb-5">Room Number: <strong class="weight-600"> D-555</strong> </p>
                    ...
                    <div class="col-md-6">
                        <div class="text-right">
                            ...
                            <p class="font-14 mb-5">Invoice No: <strong class="weight-600">255</strong></p>
                    ...
                    <div class="invoice-desc-body">
                        <ul>
                            <li class="clearfix">
                                ...
                                <div class="invoice-subtotal"><span class="weight-600">1200</span></div>
                            </li>
                            <li class="clearfix">
                            ...
                            <ul>
                                <li class="clearfix">
                                    ...
                                    <div class="id" style="">
                                        ...
                                        <div class="invoice-rate font-20 weight-600">
                                            <p class="font-14"><strong class="weight-600">1700</strong></p>
                                            <p class="font-14"><strong class="weight-600">10 %</strong></p>
                                            <p class="font-14"><strong class="weight-600">1562.93</strong></p>
                                            <p class="font-14"><strong class="weight-600">5 %</strong></p>
                                        </div>

                                        <div class="invoice-subtotal"><span class="weight-600 text-danger">1413.28 /=</span></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
