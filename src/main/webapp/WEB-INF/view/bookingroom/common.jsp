<ul class="nav nav-tabs">
	...
	<li class="nav-item"><a id="room-status" class="nav-link"
		aria-current="page" href="/bookingroom/roomstatus">Booking Details</a></li>	
	<li class="nav-item"><a id="room-home" class="nav-link"
		aria-current="page" href="/bookingroom/booked">Booked Rooms</a></li>
	<li class="nav-item"><a id="room-home" class="nav-link"
		aria-current="page" href="/bookingroom/available">Available Rooms</a></li>
	<li class="nav-item"><a id="room-pay" class="nav-link"
