      ...
      <div class="row mt-4">                    	
          <div class="col-md-6">
              <div class="form-group">                               
                  <label for="in">Payment Code</label> 
                  <input class="form-control" id="pCode" name="pCode" type="text">  
              </div>
          </div>
          <div class="col-md-6">
              <div class="form-group">                               
                  <label for="in">Room Code</label> 
                  <input class="form-control" id="rCode" name="roomCode" type="text" value="${rbk.roomCode}">  
              </div>
          </div>
      </div>
      <div class="row">                    	
          <div class="col-md-6">
              <div class="form-group">                               
                  ...
                  <input class="form-control" id="checkInDate" name="checkInDate" type="text" value="${rbk.checkInDate}">  
              </div>
          </div>
          <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input class="form-control" id="checkOutDate" name="checkoutDate" type="text" value="${rbk.checkOutDate}">                                   
              </div>
              </div>
          </div>
      </div>
      <div class="row">                    	
          <div class="col-md-6">
              <div class="form-group">                               
                  ...
                  <input class="form-control" id="roomPrice" name="roomPrice" type="text" value="${rbk.roomPrice}">  
              </div>
          </div>
          <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input class="form-control" id="discount" name="discount" type="text" value="${rbk.discount}">                                   
              </div>
              </div>
          </div>
      </div>
      <div class="row">                     	
          <div class="col-md-6">
              <div class="form-group">                          
                  ...
                  <input class="form-control" id="vat" name="vat" type="text" value="${rbk.vat}">  
              </div>
          </div>
          <div class="col-md-6">
              <div class="form-group">                          
                  <label for="status">Total Amount</label> 
                  <input class="form-control" id="total" name="total" type="text" value="${rbk.total}">  
              </div>
          </div>
      </div>
      <div class="row">                     	
          <div class="col-md-6">
              <div class="form-group">                          
                  ...
                  <input class="form-control" id="nTotal" name="netTotal" type="text" value="${rbk.netTotal}">  
              </div>
          </div>
          <div class="col-md-6">
              <div class="form-group">                          
                  <label for="status">Food Price</label> 
                  <input class="form-control" id="foodPrice" name="foodPrice" type="text" value="${rbk.foodPrice}">  
              </div>
          </div>
      </div>
    </section>
	<section>
      <div class="row">
              ...
              <div class="form-group">                          
                  ...
                  <input class="form-control" id="gtotal" name="grandTotal" type="text" value="${rbk.grandTotal}">  
              </div>
          </div>
          <div class="col-md-6">
              <div class="form-group">
