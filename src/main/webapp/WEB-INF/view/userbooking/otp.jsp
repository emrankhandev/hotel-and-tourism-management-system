						...
						<div class="row">
							<div class="col-md-9">
								...
								<div id="invoice_div" style="margin-left:260px">
									<a href="/user/invoice" id="uInvoice" style="color: white; margin-left:260px ; font-weight: bold">Print your Invoice</a>
									<!-- <button class="btn btn-primary">Print your Invoice</button> -->
